...
`KESTREL_SPLEAD=<ops>|auto` (adelanto FIJO de la CPU sobre la barrera del SP, para romper la
alternancia estricta CPU<->RSP; `auto` = **1024** en velocidad libre y 0 en `KESTREL_SPEEDMODE=hw`,
